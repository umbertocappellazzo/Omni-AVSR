...
class MultiHeadedAttention(nn.Module):
    ...
    def __init__(self, n_head, n_feat, dropout_rate):
        ...
        self.rank = 16
        self.scaling = 2/self.rank

        self.lora_down_Q = nn.Linear(n_feat, round(n_feat/self.rank), bias= False)
        self.lora_up_Q = nn.Linear(round(n_feat/self.rank), n_feat, bias= False)
        self.lora_down_V = nn.Linear(n_feat, round(n_feat/self.rank), bias= False)
        self.lora_up_V = nn.Linear(round(n_feat/self.rank), n_feat, bias= False)
