...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 31 15:17:05 2025
...
class LlamaSdpaAttention_lora(LlamaSdpaAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        Q_lora = self.lora_up_Q[modality](self.lora_down_Q(hidden_states))
        V_lora = self.lora_up_V[modality](self.lora_down_V(hidden_states))
...
class LlamaForCausalLM_HydraLora(LlamaForCausalLM):
